...
- **Pôsteres**: cada painel de trabalho pode ter um `<div class="sheet">` no fim, com um `<figure>` por produção. Grade de 5 colunas fixas, célula recortada em 2:3, dessaturada em repouso e colorida no hover. Pôster de produção com material público é link para o mesmo destino do `.plink` do texto; sem material, entra como `<figure class="mute">` sem link. Arquivos e nomes exigidos em `assets/posters/README.md`.
